...
>
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <div className="text-xl">
                        CONSTRUCTION QUALITY CERTIFICATE
                    </div>
        ...
        <div className="flex items-center">
            ...
            <div className="flex-1">
                ...
                <p className="mt-2 text-gray-600 leading-8">
                    This certifies that the property mentioned below has been professionally inspected by <b>Construction Quality Inspection Services</b> in accordance with the applicable quality assessment standards.
                </p>
    ...
    <div className="flex bg-gray-100 p-4 rounded-b-xl">
        ...
        <div className="text-sm text-gray-500 leading-7">
            ...
            <strong> Construction Quality Inspection Services</strong>.
