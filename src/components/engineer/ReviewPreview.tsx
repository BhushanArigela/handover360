...
export const ReviewPreview: React.FC<Props> = ({
    open,
    onClose,
    preview,
}) => {
                                            ...
                                            <div className="space-y-5 ">
                                                ...
                                                {section.items?.map((item: any) => {
                                                    ...
                                                    return (
                                                        ...
                                                        <div
                                                            key={item.id}
                                                            className="bg-white mt-4 border border-gray-200 rounded-lg p-4"
                                                        >
                                                            ...
                                                            {response?.videos?.length > 0 && (
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div className="font-medium">
                                                                        {response?.review_status?.replace(/_/g, " ")
                                                                            ?.replace(/\b\w/g, (c: string) => c.toUpperCase()) || "-"}
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div>
                                                                        {response?.critical_finding ? "Yes" : "No"}
                                                                    </div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div>
                                                                        {response?.rectification_required ? "Yes" : "No"}
                                                                    </div>
